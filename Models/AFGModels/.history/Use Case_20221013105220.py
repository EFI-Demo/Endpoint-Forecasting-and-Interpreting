...
if __name__ == '__main__':
    ...
    graphs_ASGMulti = read_graphForCalSim.read_graphs_in_networkx(data_file, True, 1000000) # 用于计算相似度
    graphsMulti = read_graphForCalSim.read_graphs_in_networkx2(data_file, True, 1000000) # 用于生成模型
