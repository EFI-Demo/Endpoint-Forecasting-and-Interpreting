'''
Load the models NodeRNN, EdgeRNN, and . /data/graphs to sequence the predicted graph structure. 
The results of each prediction can be used as subsequent inputs.
'''
import os
import pickle
import torch 
